...
var m = {
  ...
  fencesBeginRegex: E((l3) => new RegExp(`^ {0,${l3}}(?:\`\`\`|~~~)`)),
  headingBeginRegex: E((l3) => new RegExp(`^ {0,${l3}}#`)),
  htmlBeginRegex: E((l3) => new RegExp(`^ {0,${l3}}<(?:[a-z].*>|!--)`, "i")),
  blockquoteBeginRegex: E((l3) => new RegExp(`^ {0,${l3}}>`))
};
var Oe = /^(?:[ \t]*(?:\n|$))+/;
var we = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/;
var ye = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/;
...
var Ee = __spreadProps(__spreadValues({}, W), {
  lheading: Se,
  table: se,
...
var Ie = __spreadProps(__spreadValues({}, W), {
...
var nt = __spreadProps(__spreadValues({}, Q), {
...
`, e = e.substring(G.length + 1), k = C.slice(f);
        ...
        r.loose || (o ? r.loose = true : this.rules.other.doubleBlankLine.test(c) && (o = true)), r.items.push({
          type: "list_item",
          raw: c,
...
var x = class l {
  ...
  tokenizer;
  constructor(e) {
    this.tokens = [], this.tokens.links = /* @__PURE__ */ Object.create(null), this.options = e || T, this.options.tokenizer = this.options.tokenizer || new w(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
      inLink: false,
      inRawBlock: false,
      top: true
    };
...
var q = class {
      ...
      if (n.hooks) {
        ...
        for (let i in n.hooks) {
          ...
          P.passThroughHooks.has(i) ? r[o] = (c) => {
            if (this.defaults.async && P.passThroughHooksRespectAsync.has(i)) return (() => __async(this, null, function* () {
              let k = yield u.call(r, c);
              return a.call(r, k);
            }))();
            let p = u.call(r, c);
            return a.call(r, p);
            ...
            if (this.defaults.async) return (() => __async(this, null, function* () {
              let k = yield u.apply(r, c);
              return k === false && (k = yield a.apply(r, c)), k;
            }))();
            let p = u.apply(r, c);
            return p === false && (p = a.apply(r, c)), p;
          };
  ...
  parseMarkdown(e) {
    return (n, s) => {
      ...
      if (i.hooks && (i.hooks.options = i, i.hooks.block = e), i.async) return (() => __async(this, null, function* () {
        let u = i.hooks ? yield i.hooks.preprocess(n) : n, c = yield (i.hooks ? yield i.hooks.provideLexer(e) : e ? x.lex : x.lexInline)(u, i), p = i.hooks ? yield i.hooks.processAllTokens(c) : c;
        i.walkTokens && (yield Promise.all(this.walkTokens(p, i.walkTokens)));
        let h = yield (i.hooks ? yield i.hooks.provideParser(e) : e ? b.parse : b.parseInline)(p, i);
        return i.hooks ? yield i.hooks.postprocess(h) : h;
      }))().catch(o);
      try {
